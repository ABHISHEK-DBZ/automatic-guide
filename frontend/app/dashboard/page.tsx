            ...
            return (
              <div key={tab.id} className="flex items-center">
                ...
                <button
                  ...
                  title={tab.label}
                >
                  <span className={`${activeTab === tab.id ? 'text-cyan-400 drop-shadow-[0_0_8px_rgba(34,211,238,0.5)]' : 'text-slate-500'}`}>
                    {tab.icon}
                  </span>
        ...
        {activeTab === 'documents' && (
          <div className="h-full overflow-y-auto p-6 bg-[rgb(var(--bg-base))]">
            <div className="max-w-3xl mx-auto space-y-6">
              <div>
                <h2 className="text-3xl font-display font-bold text-white mb-2">Document Manager</h2>
                <p className="text-slate-400 font-mono text-sm">Upload study materials (PDF, DOCX, PPTX, TXT) to build your knowledge base.</p>
              </div>
              <DocumentUploader
                selectedDocumentIds={selectedDocumentIds}
