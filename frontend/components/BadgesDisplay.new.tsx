  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-display font-bold text-white mb-2">Achievement Badges</h2>
      ...
      {filteredBadges.length === 0 && (
        <div className="text-center py-12">
          ...
          <h3 className="text-xl font-display font-bold text-slate-300 mb-2">No badges found</h3>
      ...
      <div className="gc-card p-6">
        <h3 className="font-display font-bold text-lg text-white mb-4">Progress Summary</h3>
