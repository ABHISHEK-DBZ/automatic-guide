  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative group">
        ...
        >
          <div className="gc-card border-2 border-dashed border-white/10 group-hover:border-cyan-500/30 transition-all duration-300 p-12 text-center">
            {/* Glow effect on hover */}
            <div className="absolute inset-0 rounded-lg bg-gradient-to-br from-cyan-500/0 via-purple-500/0 to-cyan-500/0 group-hover:from-cyan-500/5 group-hover:via-purple-500/5 group-hover:to-cyan-500/5 transition-all duration-500 pointer-events-none" />
            
            <div className="relative space-y-4">
              {/* Icon with gradient */}
              <div className="flex justify-center">
                <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-cyan-500 to-purple-500 flex items-center justify-center text-4xl shadow-[0_0_20px_rgba(0,212,255,0.3)]">
                  📚
                </div>
              </div>
      ...
      <div className="gc-card p-6 space-y-6">
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-display font-bold text-white">Uploaded Documents</h3>
              ...
              return (
                <div
                  ...
                  className={`group relative gc-card p-4 transition-all duration-200 ${
                    checked 
                      ? 'border-cyan-500/50 bg-cyan-500/5 shadow-[0_0_15px_rgba(0,212,255,0.1)]' 
                    ...
                    <label className="flex items-start gap-3 flex-1 cursor-pointer">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="flex items-center gap-3 mt-2 text-xs font-mono">
                          ...
                          <span className="text-slate-400">•</span>
                          <span className="text-cyan-400">{doc.chunks_created} chunks</span>
                        </div>
                      </div>
                    </label>
