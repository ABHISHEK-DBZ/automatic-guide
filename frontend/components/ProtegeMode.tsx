    ...
    return (
      <div className="space-y-6 animate-fade-in">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-3xl font-display font-bold text-white mb-2">Teach Mode</h2>
            <p className="text-slate-400 font-mono text-sm">The Protégé Effect - Learn by teaching</p>
          </div>
    ...
    return (
      <div className="space-y-6 animate-fade-in">
        ...
        <div className="gc-card p-6 space-y-4">
          <h3 className="font-display font-bold text-lg text-white">Score Breakdown</h3>
